...
import { UNSAFE_enhanceManualRouteObjects, Router, useHref, createPath, useResolvedPath, useLocation, UNSAFE_DataRouterStateContext, UNSAFE_NavigationContext, useNavigate, UNSAFE_RouteContext, useMatches, useNavigation, UNSAFE_DataRouterContext } from 'react-router';
...
function useDataRouterContext(hookName) {
  let ctx = useContext(UNSAFE_DataRouterContext);
...
function useFetcher() {
  ...
  let route = useContext(UNSAFE_RouteContext);
