import { invariant, resolveTo, joinPaths, matchPath, UNSAFE_getPathContributingMatches, warning, parsePath, matchRoutes, Action, createMemoryHistory, stripBasename, AbortedDeferredError, createRouter, isRouteErrorResponse } from '@remix-run/router';
export { AbortedDeferredError, Action as NavigationType, createPath, defer, generatePath, isRouteErrorResponse, json, matchPath, matchRoutes, parsePath, redirect, resolvePath } from '@remix-run/router';
import * as React from 'react';
import { createContext, useContext, useMemo, useRef, useEffect as useEffect$1, useCallback, createElement, useState as useState$1, useLayoutEffect as useLayoutEffect$1, Component, Fragment, Children, isValidElement } from 'react';
...
const DataStaticRouterContext = /*#__PURE__*/createContext(null);
...
function useRoutes(routes, locationArg) {
  ...
  if (locationArg && renderedMatches) {
    return /*#__PURE__*/createElement(LocationContext.Provider, {
      value: {
        location: _extends({
          pathname: "/",
          search: "",
...
function DefaultErrorElement() {
  ...
  return /*#__PURE__*/createElement(Fragment, null, /*#__PURE__*/createElement("h2", null, "Unhandled Thrown Error!"), /*#__PURE__*/createElement("h3", {
    style: {
      fontStyle: "italic"
    }
  }, message), stack ? /*#__PURE__*/createElement("pre", {
    style: preStyles
  }, stack) : null, /*#__PURE__*/createElement("p", null, "\uD83D\uDCBF Hey developer \uD83D\uDC4B"), /*#__PURE__*/createElement("p", null, "You can provide a way better UX than this when your app throws errors by providing your own\xA0", /*#__PURE__*/createElement("code", {
    style: codeStyles
...
function RenderedRoute(_ref) {
  ...
  let dataStaticRouterContext = useContext(DataStaticRouterContext); // Track how deep we got in our render pass to emulate SSR componentDidCatch
...
function _renderMatches(matches, parentMatches, dataRouterState) {
  ...
  return renderedMatches.reduceRight((outlet, match, index) => {
    ...
    let getChildren = () => /*#__PURE__*/createElement(RenderedRoute, {
      match: match,
      routeContext: {
        outlet,
...
function RouterProvider(_ref) {
  ...
  return /*#__PURE__*/createElement(DataRouterContext.Provider, {
    ...
    navigator: navigator
  }, router.state.initialized ? /*#__PURE__*/createElement(Routes, null) : fallbackElement)));
}
...
function MemoryRouter(_ref2) {
  ...
  useLayoutEffect$1(() => history.listen(setState), [history]);
...
function Navigate(_ref3) {
  ...
  let dataRouterState = useContext(DataRouterStateContext);
...
function Routes(_ref5) {
  ...
  let dataRouterContext = useContext(DataRouterContext); // When in a DataRouterContext _without_ children, we use the router routes
...
function Await(_ref6) {
  ...
  return /*#__PURE__*/createElement(AwaitErrorBoundary, {
    resolve: resolve,
    errorElement: errorElement
  }, /*#__PURE__*/createElement(ResolveAwait, null, children));
}
...
class AwaitErrorBoundary extends Component {
  ...
  render() {
    ...
    if (status === AwaitRenderStatus.error) {
      ...
      return /*#__PURE__*/createElement(AwaitContext.Provider, {
        value: promise,
